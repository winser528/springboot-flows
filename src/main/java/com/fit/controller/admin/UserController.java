...
public class UserController extends BaseController {
    ...
    public String self_changePwd(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
