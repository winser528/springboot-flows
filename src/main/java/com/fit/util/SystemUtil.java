...
public class SystemUtil {
    ...
    public static Map<String, Object> getOsInfo() {
        ...
        try {
            ...
            map.put("hostName", InetAddress.getLocalHost().getHostName().toString());//获取本机计算机名称
            map.put("osName", OS_NAME);
            map.put("version", OS_VERSION);
            map.put("arch", OS_ARCH);
            map.put("sysTime", DateUtils.getCurrentDateTime());
    ...
    public static String getIp() {
        return getLocalhost().getHostAddress().toString();
    }
