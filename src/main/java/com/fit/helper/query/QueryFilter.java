package com.fit.helper.query;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import com.fit.helper.query.filter.Filter;
import com.fit.helper.query.filter.OrderbyFilter;
import com.fit.helper.query.filter.PageFilter;
import com.fit.helper.query.filter.WhereFilter;
