...
<div class="top">
    ...
    <div class="admin_logo">
        <img src="${ctx}/static/admin/images/admin_logo.jpg">
    </div>
    <!--
    <div class="top_nav">
            <ul>
...
<div class="center clearfix">
        ...
        <#list menus as menu>
            ...
            <ul class="side">
                <#list menu.children as childMenu>
                    <li><a href="${ctx}/admin/${childMenu.url}.do" target="iframe"
                           <#if (childMenu_index==0)>class="selected"</#if>>${childMenu.name}</a></li>
                </#list>
            </ul>
        </#list>
    </div>
    ...
    <div class="right">
        ...
        <p class="line"></p>
        <iframe style="overflow:visible" id="main" name="iframe" src="${ctx}/admin/overview.do" frameBorder=0 width="100%" scrolling="yes"
                height="100%"></iframe>
    </div>
</div>
</body>
