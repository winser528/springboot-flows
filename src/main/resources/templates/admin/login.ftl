...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/admin/js/jquery-1.7.2.js"></script>
...
<div class="login">
    <div class="login_form">
        <div class="form_info">
            ...
            <div class="field">
                <label>验证码：</label>
                <input id="captcha" type="text" class="text" size="3">
                <img id="captchaImg" title="看不清？请点击图片更换！" align="absmiddle" src="${ctx}/admin/captcha.do"
