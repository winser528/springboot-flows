...
<body>
    <form id="inputForm" action="${ctx }/admin/snaker/flow/process.do" method="post" target="mainFrame">
        <input type="hidden" name="processId" value="376d3e6e40f14bd6948352f5183465bc" />
