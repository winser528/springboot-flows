    ...
    <form id="inputForm" action="" method="post" target="mainFrame">
        ...
        <table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px">
            <tr>
                ...
                <td class="td_table_2" colspan="3"> &nbsp;${item.get('apply.operator')}                </td>
            </tr>
            <tr>
                <td class="td_table_1"><span>请假理由：</span></td>
                <td class="td_table_2" colspan="3"> &nbsp;${item.get('reason')}                </td>
            </tr>
            <tr>
                <td class="td_table_1"><span>请假天数：</span></td>
                <td class="td_table_2" colspan="3"> &nbsp;${item.get('day')}天</td>
            </tr>
            <tr>
                <td class="td_table_1"><span>部门经理：</span></td>
                <td class="td_table_2"> &nbsp;${item.get('approveDept.operator')}                </td>
                <td class="td_table_1"><span>总经理：</span></td>
                <td class="td_table_2"> &nbsp;${item.get('approveBoss.operator')}                </td>
            </tr>
        </table>
        </#list>
    </form>
