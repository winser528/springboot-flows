...
<form id="mainForm" action="${ctx}/snaker/process/list" method="get">
    ...
    <table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px">
        <tr>
            <td align=center width=15% class="td_list_1" nowrap> 名称</td>
            <td align=center width=35% class="td_list_1" nowrap> 流程显示名称</td>
            <td align=center width=10% class="td_list_1" nowrap> 状态</td>
            <td align=center width=10% class="td_list_1" nowrap> 版本号</td>
            <td align=center width=30% class="td_list_1" nowrap> 操作</td>
        </tr>
        <#list page.result as process>
            <tr>
                <td class="td_list_2" align=left nowrap>${process.name}&nbsp;</td>
                <td class="td_list_2" align=left nowrap>${process.displayName}&nbsp;</td>
                <td class="td_list_2" align=left nowrap>${(process.state == 1) ? string('启用','禁用')}&nbsp;</td>
                <td class="td_list_2" align=left nowrap>${process.version}&nbsp;</td>
                <td class="td_list_2" align=left nowrap>
                    <a href="${ctx}${process.instanceUrl }?processId=${process.id }&processName=${process.name }" class="btnStart"
                       title="启动流程">启动流程</a>
                    <@shiro.hasPermission name="PROCESSDEPLOY">
                        ...
                        <a href="${ctx}/snaker/process/delete/${process.id }" class="btnDel" title="删除"
