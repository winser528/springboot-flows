            ...
            <tr>
                <td colspan="20" class="query">
                    ...
                    <select name="gender" class="mr20">
                        ...
                        <option value="0" <#if ((user.gender!0)==0)>selected</#if>>女</option>
                        <option value="1" <#if ((user.gender!0)==1)>selected</#if>>男</option>
                    </select>
                    <span>用户状态：</span>
                    <select name="isDisabled" class="mr20">
                        <option value="">---请选择---</option>
                        <option value="0" <#if ((user.isDisabled!0)==0)>selected</#if>>正常</option>
                        <option value="1" <#if ((user.isDisabled!0)==1)>selected</#if>>停用</option>
                    </select>
