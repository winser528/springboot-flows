...
<!-- NewgenBiz Template by http://Templatesperfect.com -->
<head>
	<title>ABOUT</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
	<link rel="stylesheet" href="${ctx}/static/portal/css/style.css" type="text/css" media="all" />
    <script type="text/javascript" src="${ctx}/static/portal/js/jquery-1.7.2.js"></script>
	<script type="text/javascript" src="${ctx}/static/portal/js/jquery.tools.js"></script>
</head>
<body>
	<!-- Begin Wrapper -->
	<div id="wrapper">
		...
		<div id="header-holder">
			...
			<div class="shell">
				...
				<div id="header">
					...
					<h1 id="logo"><a href="#"><img src="${ctx}/static/portal/images/logo.png" alt="" /></a></h1>
				</div>
				<!-- End Header -->
			</div>
			<!-- End Shell -->
				...
				<div class="items">
					<div class="item">
					  <div class="header">
						         ...
						         <div class="top_left"><img src="${ctx}/static/portal/images/marketing.png" alt="" /></a></div>
								<div class="top_right">
...
<!-- End Slider -->
					...
					<!-- Begin Sidebar -->
					<div id="sidebar">
						<h2>Get Our Servcies</h2>
						<div class="side-list">
							<ul>
							    <li>
							      <div class="image">
						    		  <img src="${ctx}/static/portal/images/globe.png" alt="" />
						    	  </div>
							    	<div class="entry">
							    ...
							    <li>
							    	<div class="image">
							    		<img src="${ctx}/static/portal/images/box.png" alt="" />
							    	</div>
							    	<div class="entry">
							    ...
							    <li class="last">
							    	<div class="image">
							    		<img src="${ctx}/static/portal/images/user.png" alt="" />
							    	</div>
							    	<div class="entry">
					...
					<div id="content">
						<div class="article">
							...
							<div class="image">
								<img src="${ctx}/static/portal/images/image.jpg" alt="" width="240" height="180" />
          </div>
	...
	<div id="footer-holder">
		...
		<div class="shell">
			...
			<div id="footer">
				<p class="right">
					© Sitename.com. Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
				</p>
				<p>
